...
class StoreValidate extends Validate
{
    ...
    protected $scene = [
        'add'  =>  ['real_name','phone','store_name','addr','address','province_id','city_id','district_id','idcard_a','idcard_b','business_license','license'],
        'edit'  =>  ['id','real_name','phone'],
        'del'  =>  ['id'],
    ];
}